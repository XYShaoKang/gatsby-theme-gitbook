...
// see: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/js-search/index.d.ts
...
declare module "js-search" {
    ...
    class Search<T> {
        ...
        public addDocuments(documents: Array<T>): void;

        public addIndex(field: string | Array<string>): void;

        public search(query: string): Array<T>;
